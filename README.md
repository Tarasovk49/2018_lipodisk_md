...
4. [Gromacs 2018.1.](http://manual.gromacs.org/documentation/) For Gromacs simulations use the forcefield provided in the main folder (*oplsaa_lipids_polymers.ff* and *residuetypes.dat*).
